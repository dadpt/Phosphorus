...
class FlightPlan {
    ...
    constructor(PlanType: string, AircraftType: string, TASCruise: string, DepAirport: string,
      ArrAirport: string, AltAirport: string, ETD: any, ATD: any, ATA: string,
      ETA: any, AltCruise: string, AltCleared: string, hrPlan: string | undefined,
      minPlan: string | undefined, hrFuel: string | undefined,
      minFuel: string | undefined, route: string, remark: string | undefined) {
...
class Pilot {
    ...
    public constructor(cid: string, location: string | undefined, type: string,
      callsign: string, st: string, real: string, time: number, rev: number,
      reqrating: number, visualrange: number) {
